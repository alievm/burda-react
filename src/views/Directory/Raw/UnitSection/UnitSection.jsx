...
import {
    ...
    Space,
    Table,
    notification, Spin, Popconfirm, Collapse, Flex, Radio, Form, Divider, DatePicker, Segmented, Pagination
} from 'antd';
...
const UnitSection = () => {
    ...
    const fetchMainCategoriesData = async () => {
        ...
        try {
            const categories = await fetchUnits();
    ...
    const handleUpdateCategory = async () => {
        ...
        try {
            const updatedCategory = await updateUnit(editCategoryId, editCategoryTitle);
    ...
    const handleCreateNewCategory = async () => {
        ...
        try {
            const newCategory = await createUnit(newCategoryTitle);
    ...
    const handleDeleteCategory = async (categoryId) => {
        try {
            const success = await deleteUnit(categoryId);
