...
import {
    ...
    Space,
    Table,
    notification, Spin, Popconfirm, Collapse, Form, Divider, DatePicker, Radio, Flex, Segmented, Pagination
} from 'antd';
...
const Season = () => {
    ...
    const fetchMainCategoriesData = async () => {
        ...
        try {
            const response = await fetchSeasons(); // Assuming fetchSeasons fetches the data from the API
    ...
    const handleUpdateCategory = async () => {
        ...
        try {
            const updatedCategory = await updateSeason(editCategoryId, editCategoryTitle, editCategoryDesc);
    ...
    const handleCreateNewCategory = async () => {
        ...
        try {
            const newCategory = await createSeason(newCategoryTitle, newCategoryDesc);
    ...
    const handleDeleteCategory = async (categoryId) => {
        try {
            const success = await deleteSeason(categoryId);
