...
const Width = () => {
    ...
    const [checkedList, setCheckedList] = useState(['name', 'gender', 'email', 'operation']);
        ...
        <div className="p-7 bg-[#F7F7F5]">
            ...
            <div className="p-3 bg-white rounded-lg max-md:pr-5">
                <div className="flex container gap-5 max-md:flex-col max-md:gap-0">
                    ...
                    {/*    <div*/}
                    {/*        className="flex flex-col grow justify-center px-3 py-4 mx-auto w-full bg-[#FFE5A5] rounded-lg max-md:mt-5">*/}
                    {/*        <div className="flex gap-5 justify-between text-xs">*/}
                    {/*            <div className="my-auto font-medium text-zinc-800">*/}
                    {/*                Lorem ispum*/}
                    {/*            </div>*/}
                    {/*            <div*/}
                    {/*                className="flex flex-col justify-center text-right uppercase whitespace-nowrap">*/}
                    {/*                <div className="text-zinc-800">TEST</div>*/}
                    {/*                <div className="text-lime-600">+17.63</div>*/}
                    {/*            </div>*/}
                    {/*        </div>*/}
                    {/*        <div className="flex gap-5 justify-between px-px mt-4 capitalize">*/}
                    {/*            <div className="flex flex-col">*/}
                    {/*                <div className="text-xs text-zinc-500">Lorem ispum</div>*/}
                    ...
                    {/*            <img*/}
                    {/*                loading="lazy"*/}
                    {/*                src="https://cdn.builder.io/api/v1/image/assets/TEMP/1d4003611f48ebf5541a7fa4a790900f244cedc00098c8f5253ef1dcf975f2dc?apiKey=0e60d26ffe404316aa35b6241738714a&"*/}
                    {/*                className="shrink-0 my-auto aspect-[3.23] w-[78px]"*/}
                    {/*            />*/}
                    {/*        </div>*/}
                    {/*    </div>*/}
                    {/*</div>*/}
                    ...
                    {/*    <div*/}
                    {/*        className="flex flex-col grow justify-center px-3 py-4 mx-auto w-full rounded-lg bg-[#092332] max-md:mt-5">*/}
                    {/*        <div className="flex gap-5 justify-between text-xs">*/}
                    {/*            <div className="my-auto font-medium text-white">Lorem ispum</div>*/}
                    {/*            <div*/}
                    {/*                className="flex flex-col justify-center text-right uppercase whitespace-nowrap">*/}
                    {/*                <div className="text-white">TEST</div>*/}
                    {/*                <div className="text-red-500">-4.44</div>*/}
                    {/*            </div>*/}
                    {/*        </div>*/}
                    {/*        <div className="flex gap-5 justify-between px-px mt-4 capitalize">*/}
                    {/*            <div className="flex flex-col">*/}
                    ...
                    {/*            <img*/}
                    {/*                loading="lazy"*/}
                    {/*                src="https://cdn.builder.io/api/v1/image/assets/TEMP/e8159d5bf93cab725e686d82c999a8625a4d415c6e8050fc1578c6ea7c40d3ec?apiKey=0e60d26ffe404316aa35b6241738714a&"*/}
                    {/*                className="shrink-0 my-auto aspect-[3.23] w-[78px]"*/}
                    {/*            />*/}
                    {/*        </div>*/}
                    {/*    </div>*/}
                    ...
                    {/*<div className="flex flex-col ml-5 w-[23%] max-md:ml-0 max-md:w-full">*/}
                    {/*    <div*/}
                    {/*        className="flex flex-col grow justify-center px-3 py-4 mx-auto w-full bg-[#C7FFA5] rounded-lg max-md:mt-5">*/}
                    {/*        <div className="flex gap-5 justify-between text-xs">*/}
                    {/*            <div className="my-auto font-medium text-zinc-800">*/}
                    {/*                Lorem ispum*/}
                    {/*            </div>*/}
                    ...
                    {/*                className="flex flex-col justify-center text-right uppercase whitespace-nowrap">*/}
                    {/*                <div className="text-zinc-800">TEST</div>*/}
                    {/*                <div className="text-lime-600">+23.41</div>*/}
                    {/*            </div>*/}
                    {/*        </div>*/}
                    {/*        <div className="flex gap-5 justify-between px-px mt-4 capitalize">*/}
                    {/*            <div className="flex flex-col">*/}
                    {/*                <div className="text-xs text-zinc-500">Lorem ispum</div>*/}
                    {/*                <div className="mt-1 text-lg font-medium text-zinc-800">42</div>*/}
                    {/*            </div>*/}
                    {/*            <img*/}
                    {/*                loading="lazy"*/}
                    {/*                src="https://cdn.builder.io/api/v1/image/assets/TEMP/9449dc4ad2fef7b5833cfecc578f9e5a12b16f77c696568dfe8d4ed707bed0c5?apiKey=0e60d26ffe404316aa35b6241738714a&"*/}
                    {/*                className="shrink-0 my-auto aspect-[3.23] w-[78px]"*/}
                    {/*            />*/}
                    {/*        </div>*/}
                    {/*    </div>*/}
