...
const TitleSection = () => {
    ...
    const handleCreate = async () => {
        const isDuplicate = dataSource.some(item => item.title === modalData.title);
        if (isDuplicate) {
            notification.warning({
                message: 'Дубликат',
                description: 'Наименование с таким названием уже существует. Пожалуйста, введите другое название.',
            });
