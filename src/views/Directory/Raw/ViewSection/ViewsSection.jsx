...
import {
    ...
    deleteCategory,
    fetchAllCategories
} from "../../../../service/directories/categoryService.jsx";
...
import {createView, deleteView, fetchViews, updateView} from "../../../../service/directories/viewService.jsx";
...
const ViewsSection = () => {
    ...
    const handleCreate = async () => {
        try {
            ...
            const createdData = await createView(newData);
            fetchMainData();
    ...
    const columns = [
        ...
        },
        {
            ...
            key: 'category_id',
            render: (category_id) => {
                const category = categoryData.find(cat => cat.value === category_id);
                return category ? category.label : 'Неизвестно';
            },
        },
        {
            ...
            <div className="bg-white rounded-xl border border-gray-200 border-solid shadow-sm h-full min-h-[85vh]">
                <div className="flex flex-col bg-white">
                    <div className="flex gap-4 px-6 py-5 max-md:flex-wrap max-md:px-5">
                        ...
                        <Button className="flex items-center" icon={<BiSolidMessageSquareAdd size="20" />} size="large" type="primary" onClick={() => setModalVisible(true)}>Добавить категорию</Button>
                        <Modal
                            centered
                        ...
                        >
                            ...
                            <Select
                                ...
                                onChange={(value) => setModalData({...modalData, category_id: value})}
                            >
                ...
                <Layout>
                    ...
                    <Sider className="p-10" width="33%" style={siderStyle}>
                        <div
                            ...
                            <Divider className="text-white">Панель сортировки и фильтрации</Divider>
