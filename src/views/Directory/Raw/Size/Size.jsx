...
import {
    ...
    Space,
    Table,
    notification, Spin, Popconfirm, Form, Divider, DatePicker, Radio, Collapse, Flex, Segmented, Pagination
} from 'antd';
    ...
    const handleUpdateCategory = async () => {
        ...
        try {
            ...
            notification.success({
                ...
                description: 'Размерная метка успешно изменена!',
            });
        } catch (error) {
            notification.error({
                message: 'Error',
    ...
    const handleCreateNewCategory = async () => {
        ...
        try {
            ...
            notification.success({
                ...
                description: 'Размерная метка была успешно создана!',
            });
        } catch (error) {
            notification.error({
                message: 'Error',
        ...
        try {
            ...
            if (success) {
                ...
                notification.success({
                    ...
                    description: 'Размерная метка была успешно удалена!',
                });
            }
        } catch (error) {
