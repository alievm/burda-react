...
import {
    ...
    Space,
    Table,
    notification, Spin, Popconfirm, Flex, Radio, Collapse, Form, Divider, DatePicker, Segmented, Pagination
} from 'antd';
...
const Width = () => {
    ...
    const fetchMainCategoriesData = async () => {
        ...
        try {
            const response = await fetchWidth(); // Assuming fetchSeasons fetches the data from the API
    ...
    const handleUpdateCategory = async () => {
        ...
        try {
            const updatedCategory = await updateWidth(editCategoryId, editCategoryTitle, editCategoryDesc);
    ...
    const handleCreateNewCategory = async () => {
        ...
        try {
            const newCategory = await createWidth(newCategoryTitle, newCategoryDesc);
    ...
    const handleDeleteCategory = async (categoryId) => {
        try {
            const success = await deleteWidth(categoryId);
            ...
            <div className="bg-white rounded-xl border border-gray-200 border-solid shadow-sm h-full min-h-[85vh]">
                <div className="flex flex-col bg-white">
                    <div className="flex gap-4 px-6 py-5 max-md:flex-wrap max-md:px-5">
                        ...
                        <Modal
                            centered
                            title={editCategoryId ? 'Изменить ширину' : 'Добавить новую ширину'}
                        ...
                        >
                            <Input
                                placeholder="Введите название ширины"
