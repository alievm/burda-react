...
const EditableCell = ({
    ...
    if (dataIndex === 'name' || dataIndex === 'email' || dataIndex === 'gender') {
        // Render Select for 'name' field
        inputNode = (
            <Select
...
const ViewSection = () => {
    ...
    const [checkedList, setCheckedList] = useState(['name', 'gender', 'email', 'city', 'operation']);
    ...
    const columns = [
        {
            ...
            filters: [
                { text: 'По Алфавиту', value: 'name.first' },
                { text: 'Самые новые', value: 'name.last' },
            ],
            width: '20%',
            key: 'name',
            editable: true,
    ...
    const deleteRow = (key) => {
        ...
        setData(newData);
        messageApi.success('Убранно из таблицы!');
    };
