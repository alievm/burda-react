...
import {createCity, deleteCity, fetchCities, updateCity} from "../../../../service/finance/cityService.js";
import {createType, fetchTypes, updateType, deleteType} from "../../../../service/finance/typeService.js";
...
const Types = () => {
    ...
    const fetchMainCategoriesData = async () => {
        ...
        try {
            const response = await fetchTypes(); // Assuming fetchSeasons fetches the data from the API
    ...
    const handleUpdateCategory = async () => {
        ...
        try {
            const updatedCategory = await updateType(editCategoryId, editCategoryTitle, editCategoryDesc);
    ...
    const handleCreateNewCategory = async () => {
        ...
        try {
            ...
            const newCurrency = await createType(newCategoryTitle);
    ...
    const handleDeleteCategory = async (categoryId) => {
        try {
            const success = await deleteType(categoryId);
            ...
            <div className="bg-white rounded-xl border border-gray-200 border-solid shadow-sm h-full min-h-[85vh]">
                <div className="flex flex-col bg-white">
                    <div className="flex gap-4 px-6 py-5 max-md:flex-wrap max-md:px-5">
                        ...
                        <Modal
                            centered
                            title={editCategoryId ? 'Изменить тип' : 'Добавить новый тип'}
