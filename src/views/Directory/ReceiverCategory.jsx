...
import {fetchRecieverCategories, updateRecieverCategory} from "../../service/directories/receiverCategoryService.js";
...
const ReceiverCate = () => {
    ...
    const handleCreateNewCategory = async () => {
        ...
        try {
            const newCategory = await createSubEntity(newCategoryTitle, newCategoryDesc);
    ...
    const handleDeleteCategory = async (categoryId) => {
        try {
            const success = await deleteSubEntity(categoryId);
